...
|---|-----------|----------------|
| 1 | [Experiment 1 – Vagrant & NGINX Setup](lab/Exp1/intro.md) | Vagrant, VMs, NGINX |
| 2 | [Experiment 2 – Docker Container Setup](lab/Exp2/intro.md) | Docker basics, containers |
