# Experiment 6: Docker Compose vs Docker Run

## Aim

To understand the relationship between `docker run` commands and Docker Compose, and learn how to convert complex Docker run configurations into declarative `docker-compose.yml` files.
...
Running containers with many configuration flags using `docker run` becomes repetitive, error-prone, and hard to maintain — especially for multi-container applications. Docker Compose solves this by letting you define everything declaratively in a single YAML file.

### What is Docker Compose?

Docker Compose is essentially a **YAML-based wrapper** around multiple `docker run` commands. It translates your compose file into individual Docker commands behind the scenes.

---

## Part 1: Direct Comparison — `docker run` vs `docker-compose.yml`
...
```yaml
# docker-compose.yml - This does the SAME thing as the above command
version: '3.8'
services:
  nginx:
...
## Part 2: Mapping Common Docker Run Flags to Compose
...
## Part 3: Multi-Container Example Comparison
...
## Part 4: What Docker Compose Adds Beyond Docker Run
...
## Part 5: Real Conversion Example
...
## Part 6: Key Advantages of Docker Compose
